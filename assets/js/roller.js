...
d4.addEventListener('click', function() {
    ...
    fourAnswer.innerHTML = `You rolled ${fourResult}!`
});
...
d6.addEventListener('click', function() {
    ...
    sixAnswer.innerHTML = `You rolled ${sixResult}!`
});
...
d8.addEventListener('click', function() {
    ...
    eightAnswer.innerHTML = `You rolled ${eightResult}!`
});
...
d10.addEventListener('click', function() {
    ...
    tenAnswer.innerHTML = `You rolled ${tenResult}!`
});
...
d12.addEventListener('click', function() {
    ...
    twelveAnswer.innerHTML = `You rolled ${twelveResult}!`
});
...
d20.addEventListener('click', function() {
    ...
    twentyAnswer.innerHTML = `You rolled ${twentyResult}!`
});